const Footer = () => {
  return (
    <footer className="mt-16 py-6 bg-white">
      <div className="flex justify-center gap-8 flex-col sm:flex-row  p-4">
        <div>
          <div>
            <h5 className="text-4xl">Roll Realms</h5>
        ...
        <div>
          <h5>Категории:</h5>
          <ul className="flex flex-col h-full justify-evenly text-2xl gap-4 sm:gap-0">
            <div>
